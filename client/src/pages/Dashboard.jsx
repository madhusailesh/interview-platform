...
function Dashboard() {
  ...
  const scheduleInterview = async (e) => {
    ...
    if (!title || !date || !time || !candidateEmail) return;
        ...
        <main className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto items-start">
          ...
          <section className="lg:col-span-1 bg-zinc-900/40 p-6 rounded-2xl border border-zinc-900">
            ...
            <form onSubmit={scheduleInterview} className="space-y-4">
              ...
              >
                {loadingSchedule ? "Scheduling..." : "Create Session"}
              </button>
            </form>
          </section>
          ...
          <section className="lg:col-span-2 space-y-10">
            ...
            <div>
              ...
              {completedInterviews.length === 0 ? (
                <div className="text-zinc-500">No completed interviews.</div>
              ) : (
                completedInterviews.map((interview) => (
                  ...
                  >
                    ...
                    <p className="text-green-400 mt-2 text-sm">Completed</p>
                  </div>
                ))
              )}
            </div>
            ...
            <div>
              ...
              {cancelledInterviews.length === 0 ? (
                <div className="text-zinc-500">No cancelled interviews.</div>
              ) : (
                cancelledInterviews.map((interview) => (
                  ...
                  >
                    ...
                    <p className="text-red-400 mt-2 text-sm">Cancelled</p>
                  </div>
                ))
              )}
            </div>
