        ...
        peerConnection.current = new RTCPeerConnection({
          iceServers: [
...

            {
              ...
              username: "30f72c4aad2f2b24f4f79e64",

              credential: "s+IMyOiWpqVcLt58",
            },
  ...
  return (
    <div className="h-screen w-screen bg-zinc-950 text-zinc-100 flex flex-col overflow-hidden font-sans select-none">
      ...
      <main className="flex-1 flex overflow-hidden min-h-0 relative">
        ...
        <div
          className={`w-full lg:w-[40%] p-4 flex flex-col justify-center gap-4 transition-all duration-300 min-h-0 ${activeTab === "video" ? "flex" : "hidden lg:flex"}`}
        >
        ...
        <div
          className={`w-full lg:w-[60%] flex flex-col border-l border-zinc-900 bg-zinc-900/10 min-h-0 ${activeTab !== "video" ? "flex" : "hidden lg:flex"}`}
        >
          {/* CODE EDITOR WORKSPACE */}
          <div
            className={`flex-[3] min-h-0 ${activeTab === "code" || activeTab === "video" ? "flex flex-col" : "hidden lg:flex lg:flex-col"}`}
          >
          ...
          {/* ROOM CHAT PANEL */}
          <div
            className={`flex-[2] border-t border-zinc-900 bg-zinc-950/20 min-h-0 ${activeTab === "chat" ? "flex flex-col" : "hidden lg:flex lg:flex-col"}`}
          >
            <div className="hidden lg:flex items-center gap-2 px-4 py-2 bg-zinc-900/20 border-b border-zinc-900 text-xs font-semibold text-zinc-400 shrink-0">
